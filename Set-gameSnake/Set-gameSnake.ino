...
//logo w71px h20px
static const unsigned char snakeLogo[] = {
, 
...
{
	//logo w32px h32px
	static const unsigned char boardBoyLogo[] = {
	...
	u8g.firstPage();
	do {	
	u8g.drawXBM(48, 16, 32, 32, boardBoyLogo); //x, y, w, h, xbm
	} while (u8g.nextPage());
	delay(2000);
}
...
void drawSnakeLogo()
{
	...
	u8g.firstPage();
	do {	
	u8g.drawXBM(28, 13, 71, 20, snakeLogo); //x, y, w, h, xbm
    
	u8g.setFont(u8g_font_profont10);
    u8g.setPrintPos(28, 41); //x, y
    u8g.print((String) "Atari. 1979");
	
	u8g.setPrintPos(28, 48); //x, y
    u8g.print((String) "press any key");
